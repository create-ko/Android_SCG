...
/**
 * Created by seung_hee on 2017. 5. 29..
 */

public class Thrid extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //drawable id 모음
        img_id= new int[]{R.drawable.pi2_1, R.drawable.pi2_2, R.drawable.pi2_3,
                R.drawable.pi2_4, R.drawable.pi2_5, R.drawable.pi2_6};
                            ...
                            try{
                                if(card[num_sel1].getValue()==card[num_sel2].getValue()){
                                    ...
                                    if(result==6 && !flag_fi){
                                        ...
                                        UserName.getInstacne().setUser1_num2(click_number);
                                        UserName.getInstacne().setUser1_time2((long)((end_time-start_time)/1000.0));
                                        System.out.println("끝~~");
                                        show();
                                    }else if(result==6 && flag_fi){
                                        end_time = System.currentTimeMillis();
                                        UserName.getInstacne().setUser2_num2(click_number);
                                        UserName.getInstacne().setUser2_time2((long)((end_time-start_time)/1000.0));
                                        System.out.println("끝~~11111");
                                        show_number2();
                                    }
    ...
    void show()
    {
        ...
        builder.setMessage("사용자이름 : " + UserName.getInstacne().getUser1() + "\n클릭횟수 : " + UserName.getInstacne().getUser1_num2() + "번" +
                "\n시간 : " +UserName.getInstacne().getUser1_time2()+ "초" +"\n한번 더 하시겠습니까?" );
    ...
    void show_number2()
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Finish");
        builder.setMessage("사용자이름 : " + UserName.getInstacne().getUser2() + "\n클릭횟수 : " + UserName.getInstacne().getUser2_num2() + "번" +
                "\n시간 : " +UserName.getInstacne().getUser2_time2()+"초" + "\n승자를 보시겠습니까?" );
        builder.setPositiveButton("예",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        show_winner();
    ...
    void show_winner()
    {
        ...
        builder.setMessage("사용자 이름 : " + UserName.getInstacne().getUser1() +"\n클릭횟수 : " + UserName.getInstacne().getUser1_num2() +
                "   시간 : " + UserName.getInstacne().getUser1_time2()+
                "\n사용자 이름 : " + UserName.getInstacne().getUser2() +"\n클릭횟수 : " + UserName.getInstacne().getUser2_num2() +
                "   시간 : " + UserName.getInstacne().getUser2_time2()+
        ...
        builder.setPositiveButton("예",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(getApplicationContext(), Forth.class);
